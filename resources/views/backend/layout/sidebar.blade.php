<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 "
    ...
    <div class="sidenav-header">
        ...
        <a class="" href="">
            <img src="{{ asset('images/logo.png') }}" alt="{{ asset('images/logo.png') }}" width="100%" height="80px">
        </a>
    </div>
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link  " href="{{ route('walletCategories.index') }}">
                    ...
                    <span class="nav-link-text ms-1">Wallet categories</span>
                </a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
                <a class="nav-link  " href="{{ route('incomeCategories.index') }}">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <li class="nav-item">
                <a class="nav-link  " href="{{ route('costs.index') }}">
                    ...
                    <span class="nav-link-text ms-1">Costs</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link  " href="{{ route('costCategories.index') }}">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <svg width="12px" height="12px" viewBox="0 0 40 40" version="1.1"
                            xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                    ...
                    <span class="nav-link-text ms-1">Cost categories</span>
                </a>
            </li>
    ...
    {{-- <div class="sidenav-footer mx-3 ">
        <div class="card card-background shadow-none card-background-mask-secondary" id="sidenavCard">
            <div class="full-background" style="background-image: url()"></div>
